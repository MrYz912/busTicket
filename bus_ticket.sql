...
CREATE TABLE `advice` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
  CONSTRAINT `advice_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`)
...
CREATE TABLE `bus2driver` (
  ...
  CONSTRAINT `bus2driver_ibfk_1` FOREIGN KEY (`busId`) REFERENCES `bus` (`id`),
  CONSTRAINT `bus2driver_ibfk_2` FOREIGN KEY (`driverId`) REFERENCES `driver` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `busStation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cityId` int NOT NULL,
  `station` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `address` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime(6) DEFAULT CURRENT_TIMESTAMP(6),
  `updated_at` datetime(6) DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
  KEY `cityId` (`cityId`),
  CONSTRAINT `busstation_ibfk_1` FOREIGN KEY (`cityId`) REFERENCES `city` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `rider` VALUES (1, '杨振', 22, '4401621990082053132', '2021-04-03 17:49:53.326584', '2021-04-10 02:08:15.532976');
...
CREATE TABLE `ticketInfo` (
  ...
  `duration` time(6) DEFAULT NULL COMMENT '耗时',
  `riderId` int DEFAULT NULL,
  `riderName` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `riderCreditId` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `license_plate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '车牌',
  `driverId` int DEFAULT NULL,
  `created_at` datetime(6) DEFAULT CURRENT_TIMESTAMP(6),
  `updated_at` datetime(6) DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`) USING BTREE,
  ...
  KEY `riderId` (`riderId`),
  KEY `driverId` (`driverId`),
  CONSTRAINT `ticketinfo_ibfk_1` FOREIGN KEY (`tableId`) REFERENCES `timeTable` (`id`),
  CONSTRAINT `ticketinfo_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`),
  CONSTRAINT `ticketinfo_ibfk_3` FOREIGN KEY (`riderId`) REFERENCES `rider` (`id`),
  CONSTRAINT `ticketinfo_ibfk_4` FOREIGN KEY (`driverId`) REFERENCES `driver` (`id`)
...
CREATE TABLE `timeTable` (
  ...
  `endStation` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `money` int NOT NULL,
  `duration` time(6) DEFAULT NULL COMMENT '耗时',
  `count` int DEFAULT NULL,
  `distance` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '距离',
  `license_plate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '车牌',
  `driverId` int DEFAULT NULL,
  `created_at` datetime(6) DEFAULT CURRENT_TIMESTAMP(6),
  `updated_at` datetime(6) DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  ...
  CONSTRAINT `timetable_ibfk_1` FOREIGN KEY (`driverId`) REFERENCES `driver` (`id`),
  CONSTRAINT `timetable_ibfk_2` FOREIGN KEY (`startStationId`) REFERENCES `busStation` (`id`),
  CONSTRAINT `timetable_ibfk_3` FOREIGN KEY (`endStationId`) REFERENCES `busStation` (`id`)
...
CREATE TABLE `user` (
  ...
  `root` int DEFAULT NULL COMMENT '是否为管理员，1为管理员，0为普通用户',
  `created_at` datetime(6) DEFAULT CURRENT_TIMESTAMP(6),
  `updated_at` datetime(6) DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`userId`)
...
CREATE TABLE `user2rider` (
  ...
  KEY `userId` (`userId`),
  KEY `riderId` (`riderId`),
  CONSTRAINT `user2rider_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`),
  CONSTRAINT `user2rider_ibfk_2` FOREIGN KEY (`riderId`) REFERENCES `rider` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `user2rider` VALUES (1, 1, 1, '4401621990082053132', '杨振', '2021-04-03 17:51:40.665544', '2021-04-10 02:08:15.536905');
